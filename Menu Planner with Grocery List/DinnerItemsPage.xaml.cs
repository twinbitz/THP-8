...
namespace Menu_Planner_with_Grocery_List
{
    ...
    /// </summary>
    public sealed partial class DinnerItemsPage : Menu_Planner_with_Grocery_List.Common.LayoutAwarePage
    {
        // The Collection will be saved
        ObservableCollection<PlannerData> itemCollection = new ObservableCollection<PlannerData>();

        public DinnerItemsPage()
        {
        ...
        protected async override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            else
            {
                ...
                if (pageState.ContainsKey("SelectedItem") && this.itemsViewSource.View !=null)
                {
                    ...
                    this.itemsViewSource.View.MoveCurrentTo(itemTitle);
                }
            }

            // Register for DataRequesed events
        ...
        protected async override void SaveState(Dictionary<String, Object> pageState)
        {
            if (this.itemsViewSource.View != null)
            {
                ...
                {
                    string itemTitle = ((PlannerData)selectedItem).MainDish;
        ...
        {
            // the two lines of code make the selected item unselect before the text is cleared
            this.itemListView.SelectedIndex = -1;
            this.itemListView.UpdateLayout();
            editText(this, null);
            ClearFields();
