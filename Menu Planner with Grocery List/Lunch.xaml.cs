...
namespace Menu_Planner_with_Grocery_List
{
    ...
    public sealed partial class Lunch : Menu_Planner_with_Grocery_List.Common.LayoutAwarePage
    {
        ...
        string fileName = "lunchData.json";
        string imageFolder = "LunchImages";
        ...
        void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            request.Data.Properties.Description = "Lunch Item";

            // Share item text
            var lunchItem = "\r\nMAINDISH~ \r\n";
            lunchItem += String.Join("\r\n", item.MainDish);
            lunchItem += ("\r\n\r\nFRUIT~ \r\n" + item.SideDish);
            lunchItem += ("\r\n\r\nVEGGIE~ \r\n" + item.SideDish2);
            lunchItem += ("\r\n\r\nDETAIL~ \r\n" + item.Content);
            request.Data.SetText(lunchItem);
        ...
        {
            PlannerData lunch = new PlannerData();
            lunch.MainDish = itemTitle.Text;
            lunch.SideDish = itemSubtitle.Text;
            lunch.Content = itemContent.Text;
            lunch.SideDish2 = itemSide2.Text;
            lunch.Image = displayImage.Name;
            itemCollection.Insert(0, lunch);
            HideEdit(this, null);
            this.itemListView.SelectedIndex = -1;
        ...
        private async void PhotoClick(object sender, RoutedEventArgs e)
        {
            ...
            if (localFile != null)
            {
                try
                {
                    ...
                    string path = string.Format("ms-appdata:///local/LunchImages/{0}", result.Name);
