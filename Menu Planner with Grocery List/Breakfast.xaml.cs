...
namespace Menu_Planner_with_Grocery_List
{
    ...
    /// </summary>
    public sealed partial class Breakfast : Menu_Planner_with_Grocery_List.Common.LayoutAwarePage
    {
        ...
        string fileName = "breakfastData.json";
        string imageFolder = "BreakfastImages";
        ...
        void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            request.Data.Properties.Description = "Breakfast Item";
        ...
        {
            PlannerData breakfast = new PlannerData();
            breakfast.MainDish = itemTitle.Text;
            breakfast.SideDish = itemSubtitle.Text;
            breakfast.Content = itemContent.Text;
            breakfast.SideDish2 = itemSide2.Text;
            breakfast.Image = displayImage.Name;
            itemCollection.Insert(0, breakfast);
            HideEdit(this, null);
            this.itemListView.SelectedIndex = -1;
        ...
        private async void PhotoClick(object sender, RoutedEventArgs e)
        {
            ...
            if (localFile != null)
            {
                try
                {
                    ...
                    string path = string.Format("ms-appdata:///local/BreakfastImages/{0}", result.Name);
        ...
        private void itemTitleTextChanged(object sender, TextChangedEventArgs e)
        {
            Windows.Storage.ApplicationDataContainer roamingSettings = Windows.Storage.ApplicationData.Current.RoamingSettings;
            roamingSettings.Values["itemTitle"] = itemTitle.Text;
        }
