...
namespace Menu_Planner_with_Grocery_List
{
    ...
    /// </summary>
    public sealed partial class Dinner : Menu_Planner_with_Grocery_List.Common.LayoutAwarePage
    {
        ...
        string fileName = "dinnerData.json";
        string imageFolder = "DinnerImages";
        ...
        protected async override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            DataTransferManager.GetForCurrentView().DataRequested += Dinner_DataRequested;
        }

        void Dinner_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            var request = args.Request;
            var item = (PlannerData)this.itemListView.SelectedItem;
            request.Data.Properties.Title = item.MainDish;
            request.Data.Properties.Description = "Dinner Item";

            // Share item Text
            var dinnerItem = "\r\nMainDish~ \r\n";
            dinnerItem += String.Join("\r\n", item.MainDish);
            dinnerItem += ("\r\n\r\nSide~ \r\n" + item.SideDish);
            dinnerItem += ("\r\n\r\nSide~ \r\n" + item.SideDish2);
            dinnerItem += ("\r\n\r\nDetail~ \r\n" + item.Content);
            request.Data.SetText(dinnerItem);
        ...
        private async void PhotoClick(object sender, RoutedEventArgs e)
        {
            ...
            if (localFile != null)
            {
                try
                {
                    ...
                    var result = await localFile.CopyAsync(localFolder); //, "dinner.jpg", NameCollisionOption.GenerateUniqueName);
                    string path = string.Format("ms-appdata:///local/DinnerImages/{0}", result.Name);
        ...
        {
            PlannerData dinner = new PlannerData();
            dinner.MainDish = itemTitle.Text;
            dinner.SideDish = itemSubtitle.Text;
            dinner.SideDish2 = itemSide2.Text;
            dinner.Content = itemContent.Text;
            dinner.Image = displayImage.Name;
            itemCollection.Insert(0, dinner);
            HideEdit(this, null);
            this.itemListView.SelectedIndex = -1;
