...
namespace Menu_Planner_with_Grocery_List
{
    ...
    /// </summary>
    public sealed partial class BreakFastSplit : Menu_Planner_with_Grocery_List.Common.LayoutAwarePage
    {
        ObservableCollection<PlannerData> itemCollection = new ObservableCollection<PlannerData>();

        public BreakFastSplit()
        {
        ...
        protected async override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            if (localFile !=null)
            {
                ...
                itemCollection = await JsonConvert.DeserializeObjectAsync<ObservableCollection<PlannerData>>(localData);
            }
